<div class="relative w-full">
    <!-- component -->
    <div style="margin: 20px" class="fixed bottom-0 right-0 z-30 cursor-pointer shadow rounded-full">
        <div class="relative h-6 w-6 p-1 rounded-full text-white flex items-center justify-center" style="height:36px; width:36px;  background-color: {{ $panelHidden ? '#488EFE' : '#488EFE' }};" wire:click="$toggle('panelHidden')" id="btn-chat">
        ...
        <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
            <div class="relative flex items-center space-x-4">
                <div class="relative">
                    ...
                    <div class="relative h-[30px] w-[30px] p-1 rounded-full text-white flex items-center justify-center" style="background-color: #488EFE; ">
                        <x-filament-chatgpt-bot::chatgpt-svg />
                    </div>
                </div>
                ...
                @if($message['role'] == "assistant")
                    <div class="chat-message">
                        <div class="flex items-end">
                            ...
                            <div class="relative h-5 w-5 p-1 rounded-full text-white flex items-center justify-center" style="background-color: #488EFE;">
                                <x-filament-chatgpt-bot::chatgpt-svg />
                            </div>
                        </div>
                    </div>
